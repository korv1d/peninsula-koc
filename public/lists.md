...
Detachments: Pactbound Zealots (3/3 Detachment Points)
...
Character
  ...
  Lord Discordant On Helstalker (160 points)
    • Warlord
    • Baleflamer, Bladed limbs, Bolt pistol, Impaler chainglaive, Magma cutter and Slaanesh
    • Categories: Mounted, Character, Chaos, Daemon, Lord Discordant, Slaanesh

Battleline

  Cultist Mob (50 points)
    • 1 Cultist Champion with Bolt pistol, Brutal assault weapon and Khorne
    • 9 Chaos Cultists with Autopistol and Brutal assault weapon
    • Categories: Infantry, Battleline, Grenades, Chaos, Damned, Cultist Mob, Khorne

  Legionaries (90 points)
    • 1 Aspiring Champion with Chaos icon, Close combat weapon, Heavy melee weapon , Plasma pistol and Tzeentch
    • 2 Legionaries with Astartes chainsword, Bolt pistol and Close combat weapon
    • 1 Legionaries with Bolt pistol, Close combat weapon and Heavy melee weapon
    • 1 Legionaries with Bolt pistol, Close combat weapon and Heavy bolter
    • Categories: Infantry, Battleline, Chaos, Grenades, Legionaries, Tzeentch

Dedicated Transport

  Chaos Rhino (65 points)
    • Armoured tracks, 2 Combi-bolter, Havoc launcher and Tzeentch
    • Categories: Vehicle, Transport, Dedicated Transport, Smoke, Chaos, Rhino, Frame, Tzeentch

Other

  Havocs (125 points)
    • 1 Havoc Champion with Meltagun, Power fist and Tzeentch
    • 1 Havocs with Close combat weapon and Havoc heavy bolter
    • 1 Havocs with Close combat weapon and Havoc heavy bolter
    • 1 Havocs with Close combat weapon and Havoc heavy bolter
    • 1 Havocs with Close combat weapon and Havoc heavy bolter
    • Categories: Infantry, Chaos, Havocs, Tzeentch
```
...
Space Marine Blood Angels (480pts)

Bastion Task Force    2DP

Legacy of Grace        1DP


Captain With Jump Pack         - 80 pts
    Hero of the Chapter    - 20pts
...
Assault Intercessor Squad (x5)    - 80 pts

    Plasma Pistol
    Heavy bolt pistol (x4)
    Power fist
    Astartes chainsword(x4)
```
...
+ DETACHMENT: Armoured Trailblazers, Needgaârd Oathband (Sagitaur Spearhead)
+ FORCE DISPOSITION: Purge the Foe
+ TOTAL ARMY POINTS: 500pts
+
+ WARLORD: Char1: Memnyr Strategist
+ NUMBER OF UNITS: 6
+ SECONDARY: - Bring It Down: (1x2) - Assassination: 1 Characters
+++++++++++++++++++++++++++++++++++++++++++++++

Char1: 1x Memnyr Strategist (45 pts): Warlord, Autoch-pattern bolt pistol, Close combat weapon
Leading Ironkin Steeljacks with Heavy Volkanite Disintegrators

10x Hearthkyn Warriors (100 pts)
• 9x Hearthkyn Warrior
    7 with Autoch-pattern bolt pistol, Autoch-pattern bolter, Close combat weapon
    1 with Autoch-pattern bolt pistol, Close combat weapon, HYLas auto rifle
    1 with Autoch-pattern bolt pistol, Close combat weapon, Magna-rail rifle
• 1x Theyn: Weavefield crest, Autoch-pattern bolt pistol, Close combat weapon, Autoch-pattern bolter

3x Brôkhyr Thunderkyn (80 pts): 3 with Close combat weapon, SP conversion beamer
2x Cthonian Earthshakers (110 pts): 2 with 2x Autoch-pattern bolt pistol, Plasma picks, Tremor shells 
3x Ironkin Steeljacks with Heavy Volkanite Disintegrators (80 pts)
• 1x Steeljack Theyn: Preymark crest, Heavy volkanite disintegrator, Plasma knife
• 2x Ironkin Steeljack: 2 with Heavy volkanite disintegrator, Plasma knife
  Attached to Memnyr Strategist
1x Sagitaur (85 pts): Armoured wheels, Twin bolt cannon, HYLas beam cannon

Created with newrecruit.eu v35.36
```
...
+ DETACHMENT: Combined Arms, Designation Force (Born Soldiers)
+ FORCE DISPOSITION: Take and Hold
+ TOTAL ARMY POINTS: 505pts
+
+ WARLORD: Char1: Krieg Command Squad
+ NUMBER OF UNITS: 7
+ SECONDARY: - Bring It Down: (2x2) - Assassination: 1 Characters
+++++++++++++++++++++++++++++++++++++++++++++++

Char1: 6x Krieg Command Squad (60 pts)
• 5x Veteran Guardsman
    1 with Alchemyk Counteragents, Servo-scribes, Close combat weapon, Laspistol
    1 with Close combat weapon, Meltagun
    1 with Chainsword, Plasma pistol
    1 with Master vox, Close combat weapon, Lasgun
    1 with Regimental standard, Close combat weapon, Lasgun
• 1x Lord Commissar: Warlord, Laspistol, Plasma pistol, Power fist
  Leading Death Korps of Krieg

10x Death Korps of Krieg (75 pts)
...
• 1x Death Korps Watchmaster: Power weapon, Plasma pistol
  Attached to Krieg Command Squad

5x Attilan Rough Riders (60 pts)
• 1x Rough Rider Sergeant: Lasgun, Laspistol, Steed's hooves, Power sabre, Hunting lance
• 4x Rough Rider: 4 with Hunting lance, Lasgun, Laspistol, Steed's hooves
1x Chimera (75 pts): Armoured tracks, Lasgun array, Hunter-killer missile, Heavy bolter, Heavy bolter, Heavy stubber
10x Kasrkin (105 pts)
• 9x Kasrkin Trooper
...
5x Krieg Combat Engineers (65 pts)
• 4x Krieg Combat Engineer
    2 with Autopistol, Trench club
    1 with Close combat weapon, Flamer
    1 with Remote mine, Autopistol, Close combat weapon
• 1x Krieg Engineer Watchmaster: Plasma pistol, Power weapon
1x Taurox (65 pts): Armoured tracks, Twin autocannon, Storm bolter

Created with newrecruit.eu v35.72
```
...
+ FORCE DISPOSITION: Priority Assets
+ TOTAL ARMY POINTS: 475pts
+
+ WARLORD: Char1: Captain
+ ENHANCEMENT: Artificer Armour (on Char1: Captain)
+ NUMBER OF UNITS: 5
+ SECONDARY: - Bring It Down: (1x2) - Assassination: 1 Characters
+++++++++++++++++++++++++++++++++++++++++++++++

Char1: 1x Captain (100 pts): Warlord, Bolt pistol, Master-crafted bolter, Power fist
Enhancement: Artificer Armour (+20 pts)
...
• 2x Eradicator: 2 with Bolt pistol, Close combat weapon, Melta rifle
• 1x Eradicator Sergeant: Bolt pistol, Close combat weapon, Melta rifle
1x Invictor Tactical Warsuit (125 pts): Fragstorm grenade launcher, Heavy Bolter, Invictor Fist, Twin Ironhail Heavy Stubber, Incendium Cannon
```
...
Chaos Knights
Houndpack Lance and Iconoclast Fiefdom (3 Detachment Points)
Take and Hold
Strike Force (2,000 Points)
...
Gabe:
```
Blood Angels: The Blood Host
Detachments:
The Angelic Host 2pts
Vengeful Hosts 1pts
Force Disposition: Take and Hold
Captain with Jump Pack (warlord) (80)
Plasma Pistol 
Power Fist
Orksbane (Enhancement) (20)
Leading Sanguinary Guard
Sanguinary Guard (125)
2x Encarmine Spear, Angelus Boltgun
1x Encarmine Spear, Inferno Pistol

Death Company Captain With Jump Pack (75)
Power Pack
Plasma Pistol
Leading Death Company Marines with Jump Packs
Death Company Marines with Jump Packs (120)
2x Death Company Marines with Jump Pack
Heavy bolt Pistol
Astartes chainsword
1x Death Company Marines with Jump Pack
Power fist
Plasma pistol
1x Death Company Marines with Jump Pack
Power fist
...
Char1: 1x Captain (95 pts): Warlord, Heavy Bolt Pistol, Master-crafted power weapon, Relic Shield
Enhancement: The Honour Vehement (+15 pts)
Leading Bladeguard Veteran Squad
