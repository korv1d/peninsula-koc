...
const final_connectors_1 = __importDefault(require("./final-connectors"));
const FinalGame = ({ match, rowIndex, columnIndex, gameHeight, gameWidth, calculatedStyles, onMatchClick, onPartyClick, matchComponent, bracketSnippet, numOfUpperRounds, numOfLowerRounds, upperBracketHeight, lowerBracketHeight, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [columnIndex !== 0 && ((0, jsx_runtime_1.jsx)(final_connectors_1.default, Object.assign({}, {
                numOfUpperRounds,
                numOfLowerRounds,
                rowIndex,
                columnIndex,
